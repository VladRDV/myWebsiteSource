			...
			<main className={`${css(abs.main)} normal_font`}>
				<div className={`${css(abs.container)}`}>
					...
					<p className={`${css(abs.txt)}`}>
						...
						<br />
						What can I say... I keep the excitement coming by constantly seeking new knowledge and skills.
						<br />
						<br />
						<span style={{ fontWeight: 'bold' }}>What else? </span>
						<br />
						<br />
						I could go on and on about myself, beeing boring, but I think, that my{' '}
						<Link style={{ color: '#fff' }} to={Routes.blog}>
							BLOG
						</Link>{' '}
						can give you a better idea of who I am.
					</p>
				</div>
			</main>
		</Root>
